        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="bg-white rounded-lg shadow-sm p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-2xl font-semibold text-gray-900">{dashboardData.activeClients}</p>
                            <p className="text-sm text-gray-500">of {dashboardData.totalClients} total</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-2xl font-semibold text-gray-900">{dashboardData.activeProjects}</p>
                            <p className="text-sm text-gray-500">of {dashboardData.totalProjects} total</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-2xl font-semibold text-gray-900">{dashboardData.pendingTasks.length}</p>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <h2 className="text-sm font-medium text-gray-500">Projects by Status</h2>
                            <p className="text-2xl font-semibold text-gray-900">{dashboardData.projectsByStatus.active}</p>
                            <p className="text-sm text-gray-500">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <Link to="/manager/client-assignment" className="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100">
                        <svg className="h-8 w-8 text-primary-600 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                        <span className="text-sm font-medium text-gray-900">Assign Clients</span>
                    </Link>
                    <Link to="/projects/new" className="flex flex-col items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100">
                        <svg className="h-8 w-8 text-primary-600 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
