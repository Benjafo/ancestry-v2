...
export const getDocumentTypeIcon = (documentType: string) => {
    switch (documentType) {
        case 'certificate':
            return (
...
// Icon mapping for activity types (UserEvent types)
export const getActivityIcon = (type: string) => {
    switch (type) {
        ...
        case 'person_added_to_project': // Renamed from person_added
            return (
        ...
        case 'person_removed_from_project': // Renamed from person_removed
        case 'person_deleted':
            return (
